...
def new_points(n_samples: int, std_noise: float, centers: int, n_features: int,  cluster_std: float, seed: int|None|np.random.RandomState = None):
    """
    ...
    noise = np.random.normal(0, std_noise, (n_samples, n_features))
